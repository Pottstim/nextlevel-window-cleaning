// BroadwayNC.tsx — Next Level Window Cleaning
// Local SEO landing page for Broadway, NC
...
const neighborhoods = [
  "Downtown Broadway", "Broadway Village", "Carbonton Road area",
  "Broadway Road corridor", "Buckhorn area", "Osgood area",
];

export default function BroadwayNC() {
  useSEO(
    "Window Cleaning in Broadway, NC | Next Level Window Cleaning",
  ...
  return (
    <Layout>
      <ServiceSchema
        name="Window Cleaning and Exterior Washing in Broadway, NC"
        description="Professional window cleaning and exterior washing in Broadway, NC. Serving Lee County homeowners."
        url="/service-areas/broadway-nc"
      />
      <BreadcrumbSchema items={[{"name":"Home","url":"/"},{"name":"Service Areas","url":"/service-areas"},{"name":"Broadway, NC","url":"/service-areas/broadway-nc"}]} />

      {/* Hero */}
      <section className="relative min-h-[360px] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src={HERO_IMG} alt="Window cleaning Broadway NC" className="w-full h-full object-cover" />
        ...
        <div className="container relative z-10 py-14">
          <nav className="text-white/70 text-xs mb-4 flex items-center gap-1.5" style={{ fontFamily: 'Manrope, sans-serif' }}>
            ...
            <span className="text-white">Broadway, NC</span>
          </nav>
          <div className="inline-flex items-center gap-2 bg-white/15 border border-white/25 rounded-full px-3 py-1 mb-4">
            <MapPin size={13} className="text-white" />
            <span className="text-white text-xs font-bold" style={{ fontFamily: 'Manrope, sans-serif' }}>BROADWAY, NC — SERVICE AREA</span>
          </div>
          <h1 className="text-4xl lg:text-5xl font-extrabold text-white mb-4" style={{ fontFamily: 'Manrope, sans-serif' }}>
            Window Cleaning &amp; Exterior Washing in Broadway, NC
          </h1>
          <p className="text-white/85 text-lg mb-6 max-w-lg">
            Next Level Window Cleaning serves Broadway, NC and surrounding Harnett County communities. Professional, reliable, and locally trusted.
          </p>
      ...
      <section className="py-14 bg-sky-tint">
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-10 max-w-4xl mx-auto">
            <div>
              <h2 className="section-heading text-2xl text-gray-900 mb-6">Services in Broadway, NC</h2>
      ...
      <section className="py-14 bg-white">
        <div className="container max-w-3xl mx-auto">
          <h2 className="section-heading text-2xl text-gray-900 mb-6">Find Us Near Broadway, NC</h2>
          <div className="ml-5 rounded-2xl overflow-hidden shadow-lg h-64">
            <iframe
              title="Next Level Window Cleaning — Broadway NC"
              src="https://maps.google.com/maps?q=Broadway+NC+window+cleaning&output=embed"
      ...
      <CTASection
        title="Ready for Service in Broadway, NC?"
